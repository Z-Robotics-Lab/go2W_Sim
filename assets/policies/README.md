...
| 目录 | ckpt | 角色 | 体重锚 |
|---|---|---|---|
| `go2w_flat_payload_yaw/` | `model_7494.pt` | **现役默认**（yaw 轮变体A，track_ang_vel_z_exp.weight=1.75；G1 达 0.9857rad/s、G3① 零指令漂移 0.0010m/s、G3②③全过） | 6.5kg 载荷 |
| `go2w_flat_payload_5495/` | `model_5495.pt` | 回滚锚（yaw 轮前默认；载荷轮，⑤门形修正后全门过） | 6.5kg 载荷 |
