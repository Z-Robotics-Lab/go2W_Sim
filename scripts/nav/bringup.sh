...
up() {
  ...
  docker exec -d -u 0 -e DISPLAY="${DISPLAY:-:0}" -e ROS_DISTRO=jazzy \
    ...
    -e GO2W_PIPER_ENDPOINT_POSITION_TOLERANCE_RAD="${GO2W_PIPER_ENDPOINT_POSITION_TOLERANCE_RAD:-0.04}" \
    -e GO2W_PIPER_ENDPOINT_VELOCITY_TOLERANCE_RAD_S="${GO2W_PIPER_ENDPOINT_VELOCITY_TOLERANCE_RAD_S:-0.10}" \
    -e GO2W_PIPER_ENDPOINT_DWELL_S="${GO2W_PIPER_ENDPOINT_DWELL_S:-0.20}" \
    -e GO2W_PIPER_ENDPOINT_TIMEOUT_S="${GO2W_PIPER_ENDPOINT_TIMEOUT_S:-2.0}" \
    -e GO2W_PIPER_FEEDBACK_MAX_AGE_S="${GO2W_PIPER_FEEDBACK_MAX_AGE_S:-0.20}" \
